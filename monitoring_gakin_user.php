...
<?php	
	...
	$df = "SELECT grantee as user, privilege_type as privileges, table_schema as schema_name FROM information_schema.role_table_grants WHERE 1=1 and grantee not in ('postgres', 'PUBLIC') group by grantee, privilege_type, table_schema order by grantee asc";
	// echo $df."<br>";
