...
?>
		<tr>
			...
			<?php 
			$tr = "select nama from master_pengguna_ip where ip = '".$output[3]."' and db = 'wdh_44'";
			...
			<td><a href="delete_terminate.php?hapus=<?php echo $output[0];?>&id=wdh_44" class="btn btn-app btn-danger btn-sm"><i class="ace-icon fa fa-trash-o bigger-200"></i> Hapus</a></td>
		</tr>
