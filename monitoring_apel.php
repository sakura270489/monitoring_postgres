...
?>
	...
	<table border=0 align="right">
		<tr>
			...
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td><a href="#" class="btn btn-app btn-success" onClick="document.location.reload(true)">Reload</a>&nbsp;&nbsp;&nbsp;<a href="ssw_hapus_semua.php?hapus=apel" class="btn btn-app btn-danger btn-sm"><i class="ace-icon fa fa-trash-o bigger-200"></i> Hapus</a></td>
		</tr>
	</table>
	<p>&nbsp;</p>
...
?>
		<tr>
			...
			<td><a href="delete_terminate.php?hapus=<?php echo $output[0];?>&id=apel" class="btn btn-app btn-danger btn-sm"><i class="ace-icon fa fa-trash-o bigger-200"></i> Hapus</a></td>
		</tr>
