...
<table border=0 id="simple-table" class="table  table-bordered table-hover">
    <tr>
        ...
        <td class="detail-col" align = "right">&nbsp;</td>
        <td class="detail-col" align = "right">&nbsp;</td>
        <td class="detail-col"><a href="home.php?halaman=tambah_db" class="btn btn-app btn-danger btn-sm">Tambah</a></td>
    </tr>
</table>
<p>&nbsp;</p>
<?php
...
$it = "select ip_database, initcap(nama_database) nama_database, initcap(status) status, keterangan from t_database order by nama_database asc";
        // echo $it;
